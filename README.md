...
The preview Metal layer is tagged `CGColorSpace.itur_709`. Rec.709 pixels are not blit into an untagged Display P3 surface.
...
Resolve export keeps WB as a **toggleable** node. Rec.709 is not the only deliverable (timeline stays DWG Intermediate).
