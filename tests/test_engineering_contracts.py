...
def test_optimizations_records_cycles_and_leaves_p1():
    ...
    assert "Cycle 21" in text
    assert "Cycle 22" in text
    assert "Cycle 23" in text
    assert "Cycle 24" in text
    assert "Cycle 25" in text
    assert "Cycle 26" in text
    assert "Cycle 27" in text
    assert "Cycle 28" in text
    assert "Cycle 29" in text
    assert "Cycle 30" in text
    assert "Cycle 31" in text
    assert "Cycle 32" in text
    assert "Cycle 33" in text
    assert "Cycle 34" in text
    assert "Cycle 35" in text
    assert "Cycle 36" in text
    assert "Cycle 37" in text
    assert "Cycle 38" in text
    assert "Cycle 39" in text
