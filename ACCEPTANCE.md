...
- WB is scene-linear Bradford/CAT02 (CCT + tint), not baked into the IDT or Rec.709 ODT cubes.
- Timeline/working space remains DaVinci Wide Gamut Intermediate when WB is off. Remaining graph: IDT → working space → optional Rec.709 ODT.
