...
colorspaces:
  ...
  - !<ColorSpace>
    ...
    description: |
      ...
      Every IDT lands here, then converts to ACEScct for WB / preview.
  ...
  - !<ColorSpace>
    ...
    isdata: false
    description: |
      ACEScct (AP1 log). Internal grading / WB / preview encoding.
      Implemented (unverified). White balance is scene-linear ACEScg, never log.
