"""Internal working encodings: ACEScct (default) and optional DaVinci Intermediate.

Default M1 working encoding is ACEScct (AP1 log). Scene-linear interchange
is ACES2065-1 (AP0). White balance runs in ACEScg (AP1) linear, wrapped in
ACEScct for the timeline / preview.
