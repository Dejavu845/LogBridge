"""Fixed M1 pipeline: IDT → ACES2065-1 → ACEScct WB → Rec.709 ODT.

Not a node editor. The serial graph lives in ``color.graph`` and is shared
with Resolve export. WB is a toggleable node; Rec.709 is a later ODT, not
the only deliverable.

Every IDT goes to ACES2065-1. Convert to ACEScct for WB / preview.
